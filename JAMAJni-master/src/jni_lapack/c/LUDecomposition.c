...
JNIEXPORT jint JNICALL Java_JAMAJni_LUDecomposition_dgetri
...
/*
JNIEXPORT void JNICALL Java_JAMAJni_jniLAPACK_dpotrf
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dpotri
  (JNIEnv *env, jclass obj, jint layout, jchar juplo, jint n, jdoubleArray ja,
   jint lda, jintArray jinfo)
{
    double *a = (*env)-> GetDoubleArrayElements (env, ja, NULL);
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dpotrs
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dgeqrf
  (JNIEnv *env, jclass obj, jint layout, jint m, jint n, jdoubleArray ja,
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dorgqr
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dgeqp3
  (JNIEnv *env, jclass obj, jint layout, jint m, jint n, jdoubleArray ja,
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dgeev
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dgesvd
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dgesdd
...
JNIEXPORT void JNICALL Java_JAMAJni_jniLAPACK_dsyev
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dgesv
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dggev
  (JNIEnv *env, jclass obj, jint layout, jchar jjobvl, jchar jjobvr, jint n,
...
JNIEXPORT jint JNICALL Java_JAMAJni_jniLAPACK_dsygv
