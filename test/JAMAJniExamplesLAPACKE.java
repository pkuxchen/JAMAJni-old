...
public final class JAMAJniExamplesLAPACKE {
	private JAMAJniExamplesLAPACKE() {}
	public static void main(String[] args) {
        ...
        //ipiv = pivot indices       
        LUDecomposition.dgetrf( matrix_layout, m, n, a, lda, ipiv);
        ...
        LUDecomposition.dgetrs(matrix_layout, trans, n, nrhs, a, lda, ipiv, b, ldb);
        ...
        CholeskyDecomposition.dpotrf(matrix_layout, uplo, n, a, lda);
        ...
        CholeskyDecomposition.dpotrs(matrix_layout, uplo, n, nrhs, a, lda, b, ldb);
        ...
        QRDecomposition.dgeqrf(matrix_layout, m, n, a, lda, tau);
        ...
        QRDecomposition.dorgqr(matrix_layout, m, n, k, a, lda, tau);
        ...
        QRDecomposition.dgeqp3(matrix_layout, m, n, a, lda, jpvt, tau);
        ...
        EigenvalueDecomposition.dgeev(matrix_layout, jobvl, jobvr, n, a, lda, wr, wi, vl, ldvl, vr, ldvr);
        ...
        SingularValueDecomposition.dgesvd(matrix_layout, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, superb);
        ...
        SingularValueDecomposition.dgesdd(matrix_layout, jobu, m, n, a, lda, s, u, ldu, vt, ldvt);
        printMatrix("  The overwritten matrix A :", matrix_layout, a, m, n);
        printMatrix("\n  The singular values of A :", matrix_layout, s, 1, m);
        printMatrix("\n  Left singular vectors (in columns) :", matrix_layout, u, m, n);
        printMatrix("\n  Right singular vectors (in rows):", matrix_layout, vt, n, n);       
