...
public class CholeskyDecomposition implements java.io.Serializable {
	...
	public CholeskyDecomposition (Matrix Arg) {
        ...
        int lda = n;
        isspd = isspd & (dpotrf(matrix_layout, uplo, n, a, lda) == 0);
    }
    ...
    * ------------------------ */
	...
	public Matrix solve (Matrix B) {
		...
		dpotrs(matrix_layout, uplo, n, nrhs, a, lda, b, ldb);
    ...
    public static native int dpotrs(int matrix_layout, char uplo, int n, int nrhs,
