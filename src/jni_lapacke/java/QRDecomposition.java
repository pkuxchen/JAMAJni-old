...
public class QRDecomposition implements java.io.Serializable {
 static {
    ...
    public QRDecomposition (Matrix Arg) {
        ...
        dgeqrf(matrix_layout, m, n, QR, lda, tau);
   ...
   /** Generate and return the (economy-sized) orthogonal factor*/
    ...
    public Matrix solve (Matrix B) {
        ...
        int k = l, lda = m, ldb = m;
        dormqr(matrix_layout, side, trans, m, nx, k, QR, lda, tau, b, ldb);
    ...
    public static native int dorgqr(int matrix_layout, int m, int n, int k, double[] a,
                                    int lda, double[] tau);
